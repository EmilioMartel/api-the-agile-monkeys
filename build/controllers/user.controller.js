...
var createUser = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var _req$body, username, email, password, roles, rolesFound, user, token, decoded, userLogged, savedUser;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 15:
            ...
            user.updatedBy = userLogged._id; // saving the new user
...
var updateUserById = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res) {
    var token, decoded, userLogged, updatedUser;
